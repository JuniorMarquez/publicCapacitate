...
app.controller('historicoArticuloCtrl', ['$scope', '$http', '$filter', '$modal', 'MyService', 'filterFilter', 'datepickerConfig',function($scope, $http, $filter,$modal, MyService,filterFilter, datepickerConfig) {
    $scope.getGrafico =function(){
      ...
      $http.get('http://54.202.62.62:1346/ordeno/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
...
$scope.getPesos = function () {
      $scope.pesos=null;
      $http.get('http://54.202.62.62:1346/peso/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
    ...
    $scope.getEntradas = function () {
      ...
      $http.get('http://54.202.62.62:1346/tratamiento/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
    ...
    $scope.getDepartamentos = function () {
      ...
      $http.get('http://54.202.62.62:1346/sumdepartamento/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
    ...
    $scope.getMedicamentos = function () {
      ...
      $http.get('http://54.202.62.62:1346/summedicamento/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
    ...
    $scope.getMedicamentos();
     $scope.getAlimentos = function () {
      ...
      $http.get('http://54.202.62.62:1346/sumalimento/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
    ...
    $scope.getSaltos = function () {
      $scope.saltos=null;
      $http.get('http://54.202.62.62:1346/salto/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
    ...
    $scope.getPromedio =function(){
      ...
      $http.get('http://54.202.62.62:1346/ordeno').then(function (resp) {
