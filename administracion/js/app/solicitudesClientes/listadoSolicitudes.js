...
//   var dato="";
//   var datosCuenta="";
//   $http.get('http://54.202.62.62:1346/solicitud/'+iden).success(function(respuesta){          
...
$scope.openDetalles = function(item,timeout){
  var nuevo={};
  nuevo.identif=item;
  $http.put('http://54.202.62.62:1346/solicitud/'+item ,nuevo); 
  setTimeout(function() {
    $http.get('http://54.202.62.62:1346/solicitud/?identif=' +item).success(function(respuesta){
